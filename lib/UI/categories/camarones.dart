...
class ListaCamarones extends StatefulWidget {
  @override
  _ListaCamaronesState createState() => _ListaCamaronesState();
}

class _ListaCamaronesState extends State<ListaCamarones> {
  @override
  Widget build(BuildContext context) {
   final productos = Provider.of<List<Producto>>(context);

    final String categoria = "camarones";
