...
class ListaOtros extends StatefulWidget {
  @override
  _ListaOtrosState createState() => _ListaOtrosState();
}

class _ListaOtrosState extends State<ListaOtros> {
  @override
  Widget build(BuildContext context) {
    final productos = Provider.of<List<Producto>>(context);

    final String categoria = "otros";
