...
import 'package:reef_town/UI/Pages/perfil_direccion.dart';
import 'package:reef_town/UI/pages/perfil_tarjetas.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Card(
                child: ListTile(
                  title: Text("Tarjetas ingresas",
                    textScaleFactor: 1.2,
                  ),
                  onTap:() { Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TarjetasPerfil()),
                  );},
                  trailing: Icon(Icons.arrow_forward_ios)
                  ,
                ),
